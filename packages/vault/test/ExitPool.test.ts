...
import { encodeExit } from '@koil-finance/helpers/src/models/pools/mockPool';
...
import { lastBlockNumber, MONTH } from '@koil-finance/helpers/src/time';
import { MAX_GAS_LIMIT, MAX_UINT256, ZERO_ADDRESS } from '@koil-finance/helpers/src/constants';
import { arrayAdd, arraySub, BigNumberish, bn, fp } from '@koil-finance/helpers/src/numbers';
...
describe('Exit Pool', () => {
  ...
  sharedBeforeEach('deploy vault & tokens', async () => {
    const WFUSE = await TokensDeployer.deployToken({ symbol: 'WFUSE' });

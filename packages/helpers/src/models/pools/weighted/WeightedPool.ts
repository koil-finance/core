...
import { WeightedPoolEncoder } from '../../../utils/pool-weighted';
...
export default class WeightedPool {
  ...
  async estimateBptPrice(
    ...
    return calculateKPTPrice(currentBalance, this.weights[tokenIndex], currentSupply);
  }
  ...
  private _buildJoinGivenInParams(params: JoinGivenInWeightedPool): JoinExitWeightedPool {
    ...
    return {
      ...
      protocolFeePercentage: params.protocolFeePercentage,
      data: WeightedPoolEncoder.joinExactTokensInForKPTOut(amountsIn, params.minimumBptOut ?? 0),
    };
  }
  ...
  private _buildJoinGivenOutParams(params: JoinGivenOutWeightedPool): JoinExitWeightedPool {
    return {
      ...
      currentBalances: params.currentBalances,
      protocolFeePercentage: params.protocolFeePercentage,
      data: WeightedPoolEncoder.joinTokenInForExactKPTOut(params.bptOut, this.tokens.indexOf(params.token)),
    };
  }
  ...
  private _buildJoinAllGivenOutParams(params: JoinAllGivenOutWeightedPool): JoinExitWeightedPool {
    return {
      ...
      currentBalances: params.currentBalances,
      protocolFeePercentage: params.protocolFeePercentage,
      data: WeightedPoolEncoder.joinAllTokensInForExactKPTOut(params.bptOut),
    };
  }
  ...
  private _buildExitGivenOutParams(params: ExitGivenOutWeightedPool): JoinExitWeightedPool {
    ...
    return {
      ...
      currentBalances: params.currentBalances,
      protocolFeePercentage: params.protocolFeePercentage,
      data: WeightedPoolEncoder.exitKPTInForExactTokensOut(amountsOut, params.maximumBptIn ?? MAX_UINT256),
    };
  }
  ...
  private _buildSingleExitGivenInParams(params: SingleExitGivenInWeightedPool): JoinExitWeightedPool {
    return {
      ...
      currentBalances: params.currentBalances,
      protocolFeePercentage: params.protocolFeePercentage,
      data: WeightedPoolEncoder.exitExactKPTInForOneTokenOut(params.bptIn, this.tokens.indexOf(params.token)),
    };
  }
  ...
  private _buildMultiExitGivenInParams(params: MultiExitGivenInWeightedPool): JoinExitWeightedPool {
    return {
      ...
      currentBalances: params.currentBalances,
      protocolFeePercentage: params.protocolFeePercentage,
      data: WeightedPoolEncoder.exitExactKPTInForTokensOut(params.bptIn),
    };
  }

...
import StablePool, { SWAP_INTERFACE } from '@koil-finance/helpers/src/models/pools/stable/StablePool';
import { RawStablePoolDeployment } from '@koil-finance/helpers/src/models/pools/stable/types';
import {
  advanceTime,
  currentTimestamp,
  DAY,
...
} from '@koil-finance/helpers/src/time';
  ...
  function itBehavesAsStablePool(numberOfTokens: number) {
    ...
    describe('onJoinPool', () => {
      ...
      context('initialization', () => {
        it('grants the invariant amount of KPT', async () => {
      ...
      context('join exact tokens in for KPT out', () => {
        ...
        context('once initialized', () => {
          ...
          it('grants KPT for exact tokens', async () => {
            ...
            // Make sure received KPT is closed to what we expect

...
// File contracts/interfaces/IKoilRelayer.sol
...
// File contracts/relayer/KoilRelayer.sol
...
// File contracts/interfaces/IBaseRelayerLibrary.sol
...
// File contracts/relayer/BaseRelayerLibrary.sol
 ...
 * @dev
 * Relayers are formed out of a system of two contracts:
 *  - A `KoilRelayer` contract which acts as a single point of entry into the system through a multicall function
...
contract BaseRelayerLibrary is IBaseRelayerLibrary {
    ...
    IVault private immutable _vault;
    IKoilRelayer private immutable _entrypoint;

    constructor(IVault vault) IBaseRelayerLibrary(vault.WFUSE()) {
        _vault = vault;
        _entrypoint = new KoilRelayer(vault, address(this));
    }
    ...
    function getEntrypoint() public view returns (IKoilRelayer) {
        return _entrypoint;
    }
    ...
    // solhint-disable-next-line var-name-mixedcase
    bytes32 private immutable _TEMP_STORAGE_SUFFIX = keccak256("koil.base-relayer-library");
...
// File contracts/interfaces/IStaticATokenLM.sol
...
// File contracts/relayer/AaveWrapping.sol
...
// File contracts/interfaces/IstFUSE.sol
...
// File contracts/interfaces/IwstFUSE.sol
...
// File contracts/relayer/LidoWrapping.sol
...
// File @koil-finance/solidity-utils/contracts/helpers/VaultHelpers.sol@v1.0.1
...
// File @koil-finance/pool-weighted/contracts/WeightedPoolUserData.sol@v1.0.1
...
// File contracts/relayer/VaultActions.sol
...
// File @koil-finance/solidity-utils/contracts/openzeppelin/IERC20PermitDAI.sol@v1.0.1
...
// File contracts/relayer/VaultPermit.sol
...
// File contracts/BatchRelayerLibrary.sol
